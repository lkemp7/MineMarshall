...
urlpatterns = [
    ...
    path('projects/<int:pk>/documents/project/add/', views.add_project_approval_document, name='add_project_approval_document'),
    path('projects/<int:project_pk>/documents/role/<int:role_pk>/add/', views.add_role_approval_document, name='add_role_approval_document'),
    path('documents/<int:doc_id>/delete/', views.delete_approval_document, name='delete_approval_document'),
    ...
    path('project-invites/<int:invite_id>/form/draft/', views.save_form_draft, name='save_form_draft'),
